...
- Desktop sidebar width is draggable from its right edge, from 200px to a maximum of 700px (default 232px). The separator supports Left/Right arrows and Home/End. Mobile keeps the fixed-width drawer.
